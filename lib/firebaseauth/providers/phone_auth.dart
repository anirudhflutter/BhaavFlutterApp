import 'package:bhaav/firebaseauth/firebase/auth/auth.dart';
...
class PhoneAuthDataProvider with ChangeNotifier {
  ...
  setMethods(
      {TextEditingController phoneNumberField,
      VoidCallback onStarted,
  ...
  //
  // set phoneNumberField(String fieldName) {
  //     _phoneNumberField = (fieldName == "sign-up") ? _phoneNumberController : mobileNumberControllerLogin;
  // }

  TextEditingController get phoneNumberController => _phoneNumberField;
}
